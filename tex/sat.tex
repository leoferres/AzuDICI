...
%%% First figure 
  \begin{figure}[htp]
    \centering
    \includegraphics[scale=.3]{SharedNonePerfDecay.eps}
    \caption{MyCaption}
    \label{fig:MyLabel}
  \end{figure}
%%% Second figure 
  \begin{figure}[htp]
    \centering
    \includegraphics[scale=.3]{SharedNonePercentCacheMisses.eps}
    \caption{MyCaption}
    \label{fig:MyLabel}
  \end{figure}
\end{minipage}
...
%%% First figure 
  \begin{figure}[htp]
    \centering
    \includegraphics[scale=.3]{SharedAllPerfDecay.eps}
    \caption{MyCaption}
    \label{fig:MyLabel}
  \end{figure}
%%% Second figure 
  \begin{figure}[htp]
    \centering
    \includegraphics[scale=.3]{SharedAllPercentCacheMisses.eps}
    \caption{MyCaption}
    \label{fig:MyLabel}
  \end{figure}
\end{minipage}
...
%%% First figure 
  \begin{figure}[htp]
    \centering
    \includegraphics[scale=.3]{SharedBinaryPerfDecay.eps}
    \caption{MyCaption}
    \label{fig:MyLabel}
  \end{figure}
%%% Second figure 
  \begin{figure}[htp]
    \centering
    \includegraphics[scale=.3]{SharedBinaryPercentCacheMisses.eps}
    \caption{MyCaption}
    \label{fig:MyLabel}
  \end{figure}
\end{minipage}
