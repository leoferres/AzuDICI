...
tested a \emph{modified} \pling\ in a 6-core multicore machine, varying the number of
threads. \pling was modified in order that, for each {\em thread worker}, the {\em same search} is performed (i.e. same strategies, starting parameters and no lemma exchanging occur). 
In Figure \ref{fig:decay} we can see how modified-\pling's performance
...
the same machine.
>>>>>>> bde3f5a6324f6221687a49fbeb1ff1e1f3832096
