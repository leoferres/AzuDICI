...
set xtics nomirror
set ytics nomirror
plot "plingeling_6cores_speedup.dat" using 1:2 lt 2 lw 0.5 ps 0.5 title '{/Times=6 goldb-heqc-i8mul}' with linespoints, \
"plingeling_6cores_speedup.dat" using 1:3 lt 2 lw 0.5 ps 0.5 title '{/Times=6 hoons-vbmc-s04-06}' with linespoints, \
"plingeling_6cores_speedup.dat" using 1:4 lt 2 lw 0.5 ps 0.5 title '{/Times=6 manol-pipe-c6bid_i}' with linespoints, \
"plingeling_6cores_speedup.dat" using 1:5 lt 2 lw 0.5 ps 0.5 title '{/Times=6 manol-pipe-c7nidw}' with linespoints, \
"plingeling_6cores_speedup.dat" using 1:6 lt 2 lw 0.5 ps 0.5 title '{/Times=6 manol-pipe-g10idw}' with linespoints, \
"plingeling_6cores_speedup.dat" using 1:7 lt 2 lw 0.5 ps 0.5 title '{/Times=6 manol-pipe-g10nid}' with linespoints, \
"plingeling_6cores_speedup.dat" using 1:8 lt 2 lw 0.5 ps 0.5 title '{/Times=6 velev-pipe-uns-1.1-7}' with linespoints
